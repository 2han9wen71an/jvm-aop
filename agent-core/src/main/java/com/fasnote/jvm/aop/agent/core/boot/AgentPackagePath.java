...
package com.fasnote.jvm.aop.agent.core.boot;
...
/**
 * AgentPackagePath is a flag and finder to locate the jvm aop agent.jar. It gets the absolute path of the agent jar.
