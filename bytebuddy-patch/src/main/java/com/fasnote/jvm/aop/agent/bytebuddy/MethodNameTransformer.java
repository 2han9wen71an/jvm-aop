...
package com.fasnote.jvm.aop.agent.bytebuddy;
 ...
 */
public class MethodNameTransformer implements net.bytebuddy.dynamic.scaffold.inline.MethodNameTransformer {

    private static final String DEFAULT_PREFIX = "original$";

    private String prefix;

    public MethodNameTransformer(String nameTrait) {
